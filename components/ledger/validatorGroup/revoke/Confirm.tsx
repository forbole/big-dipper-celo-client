...
type RevokeValGroupConfirmProps = { revokeAmount: string; validatorGroup?: string };

const Confirm = ({ revokeAmount, validatorGroup }: RevokeValGroupConfirmProps): JSX.Element => {
                        ...
                        <Grid container className={classes.dialogContent}>
                            <Grid item xs={12}>
                                <Typography
                                    ...
                                    color="textPrimary"
                                    gutterBottom>
                                    You’re going to revoke {revokeAmount} CELO from {validatorGroup}
                                    , if that is correct, please sign in your ledger device.
                                </Typography>
                            </Grid>
                            <Grid item xs={12}>
