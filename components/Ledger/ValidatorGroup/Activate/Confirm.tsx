...
type ActivateVoteValGroupConfirmProps = { validatorGroup?: string };

const Confirm = ({ validatorGroup }: ActivateVoteValGroupConfirmProps): JSX.Element => {
                        ...
                        <Grid container className={classes.dialogContent}>
                            <Grid item xs={12}>
                                <Typography
                                    ...
                                    color="textPrimary"
                                    gutterBottom>
                                    You’re going to activate your votes for Validator Group with
                                    address {validatorGroup}. If that is correct, please sign in
                                    your ledger device.
                                </Typography>
                            </Grid>
                            <Grid item xs={12}>
